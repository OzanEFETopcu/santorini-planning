...
const PLACES = [
  ...
  { name: 'Artemis Karamolegos', cat: 'wine', img: 'img/artemis-karamolegos.webp', imgKind: 'venue', imgFrom: 'artemiskaramolegos-winery.com', group: 'Short drive — 15 min or less', lat: 36.3883, lon: 25.4636, area: 'Exo Gonia', rank: 8,
    price: '€30 tasting · €40–95 with food', dur: 'hourly tours 12:00–18:00, open 11–20 daily',
    url: 'https://www.artemiskaramolegos-winery.com/en/tasting-room/wine-tasting/',
    priceSource: 'their winetourism.com listing, checked Aug 2026',
    tastings: [
      { name: 'Volcanic Wine Tasting', dur: 'tasting only', price: '€30' },
      { name: 'Wine & Gastronomy Journey', dur: 'tasting with food', price: '€40' },
      { name: 'Wine & Feast', dur: 'full food pairing', price: '€75' },
      { name: 'Assyrtiko & Santorini Feast', dur: 'top pairing menu', price: '€95' },
    ],
    note: 'Volcanic Wine Tasting €30, Wine & Gastronomy Journey €40, Wine & Feast €75, Assyrtiko & Santorini Feast €95. Sea-view courtyard, own restaurant.',
    verdict: 'Flexible — hourly tours and drop-ins — but no longer the cheap option: the old €8 flights are gone.' },
