...
const PLACES = [
  ...
  { name: 'Gavalas Winery', cat: 'wine', img: 'img/gavalas-winery.png', imgKind: 'venue', imgFrom: 'gavalaswines.gr', type: 'family winery', group: 'Walk from the base',
    lat: 36.3759, lon: 25.4312, area: 'Megalochori', rank: 1,
    dur: 'tastings bookable online; prices not published',
  ...
  { name: 'Canava Roussos', cat: 'wine', img: 'img/canava-roussos.jpg', imgKind: 'venue', imgFrom: 'santorinidave.com', type: 'oldest winery on the island', group: 'Short drive — 15 min or less',
    lat: 36.3841, lon: 25.4633, area: 'Mesa Gonia, on the Kamari road', rank: 3,
  ...
  { name: 'Vassaltis Vineyards', cat: 'wine', img: 'img/vassaltis-vineyards.jpg', imgKind: 'venue', imgFrom: 'vassaltis.com', group: 'Short drive — 15 min or less', lat: 36.4344, lon: 25.4386, area: 'Vourvoulos', rank: 4,
  ...
  { name: 'Domaine Sigalas', cat: 'wine', img: 'img/domaine-sigalas.jpg', imgKind: 'venue', imgFrom: 'sigalas-wine.com', group: 'The north end — 25–30 min each way', lat: 36.4713, lon: 25.3943, area: 'Baxedes, near Oia', rank: 10,
  ...
  { name: 'Estate Argyros', cat: 'wine', img: 'img/estate-argyros.webp', imgKind: 'venue', imgFrom: 'estateargyros.com', group: 'Short drive — 15 min or less', lat: 36.3836, lon: 25.4647, area: 'Episkopi Gonia', rank: 5,
  ...
  { name: 'Hatzidakis Winery', cat: 'wine', img: 'img/hatzidakis-winery.jpg', imgKind: 'venue', imgFrom: 'hatzidakiswines.gr', group: 'Short drive — 15 min or less', lat: 36.3713, lon: 25.4394, area: 'Pyrgos Kallistis', rank: 6,
  ...
  { name: 'Venetsanos', cat: 'wine', img: 'img/venetsanos.jpg', imgKind: 'venue', imgFrom: 'venetsanoswinery.com', group: 'Short drive — 15 min or less', lat: 36.3825, lon: 25.4315, area: 'Megalochori, above Athinios', rank: 7,
  ...
  { name: 'Pelican Kipos', cat: 'wine', img: 'img/pelican-kipos.png', imgKind: 'venue', imgFrom: 'pelicankipos.com', group: 'Short drive — 15 min or less', lat: 36.4184, lon: 25.4328, area: 'Fira centre', rank: 8,
  ...
  { name: 'Santo Wines', cat: 'wine', img: 'img/santo-wines.jpg', imgKind: 'venue', imgFrom: 'santowines.gr', group: 'Short drive — 15 min or less', lat: 36.3876, lon: 25.4365, area: 'Pyrgos', rank: 9,
