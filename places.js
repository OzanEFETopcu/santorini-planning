...
const PLACES = [
  ...
  { name: 'Gavalas Winery', cat: 'wine', img: 'img/gavalas-winery.png', imgKind: 'venue', imgFrom: 'gavalaswines.gr', type: 'family winery', group: 'Walk from the base',
    ...
    tastings: [
      { name: 'Introduction to Santorini', dur: '50–60 min', price: '€26.21',
        includes: '4 wines · sommelier presentation · detailed brochure on the wines to keep · small snack of cheese and barley rusks' },
      { name: 'White Expressions of Santorini', dur: '50–60 min', price: '€34.60',
        includes: '4 dry white wines · sommelier presentation · brochure to keep · small snack of cheese and barley rusks' },
      { name: 'Explore Santorini', dur: '60–70 min', price: '€41.94',
        includes: '5 wines, each with its own bite pairing · sommelier presentation · brochure to keep' },
      { name: 'Premium and Rare', dur: '60–70 min', price: '€52.42',
        includes: '6 wines, each with its own bite pairing · sommelier presentation · brochure to keep',
        note: 'their booking page calls this the rarest Greek varieties · adults 18+' },
    ],
  ...
  { name: 'Artemis Karamolegos', cat: 'wine', img: 'img/artemis-karamolegos.webp', imgKind: 'venue', imgFrom: 'artemiskaramolegos-winery.com', group: 'Short drive — 15 min or less', lat: 36.3883, lon: 25.4636, area: 'Exo Gonia', rank: 8,
    price: '€34–80', dur: '1–2 h · hourly tours 12:00–18:00',
    url: 'https://www.artemiskaramolegos-winery.com/en/tasting-room/wine-tasting/',
    priceSource: 'their own booking pages, checked with you Aug 2026 — their winetourism listing quotes different figures (€30–95)',
    tastings: [
      { name: 'The Indigenous Wine Tasting', dur: '1 h', price: '€34',
        includes: 'Introduction to the island\'s indigenous varieties · 5 wines: Terra Nera White, Aidani, Rosé and Red, then Vinsanto' },
      { name: 'The Roots Wine Tasting', dur: '1 h 30', price: '€42',
        includes: 'The local varieties in one flight · 5 wines: Santorini, 34, Nykteri, Mavrotragano, Vinsanto' },
      { name: 'The Golden Stars Wine Tasting', dur: '2 h', price: '€66',
        includes: 'Their flagship Assyrtiko vintages · 7 wines: Terra Nera Assyrtiko, Santorini, 34, Nykteri, Mystirio, Ftelos, Vinsanto' },
      { name: 'Wine Tasting + lunch or dinner at Aroma Avlis', dur: '2 h', price: '€72',
        includes: '4 wines paired with local dishes, then a meal at their own restaurant on the winery grounds. The tasting can run alongside the meal',
        note: 'the meal is à la carte with €62 pp prepaid — anything over that is paid on the spot' },
      { name: 'The Premium Wine Tasting', dur: '1 h 30', price: '€80',
        includes: 'Their best vintages · 5 wines: Pyritis, Mystirio, Kamaras, Ftelos, Vinsanto · with a long plate of bites — goat cream cheese, apochti cured meat, fava tart, octopus with caper leaves, dakos, smoked eel, bottarga blinis, aged Arseniko from Naxos and more' },
    ],
    note: 'Five tastings from €34 to €80, plus a package with a meal at Aroma Avlis, their restaurant on the grounds. Sea-view courtyard.',
    verdict: 'The widest choice of any winery here — five tastings plus a meal package — but it starts at €34, so not the cheap stop it used to be.' },
  { name: 'Canava Roussos', cat: 'wine', img: 'img/canava-roussos.jpg', imgKind: 'venue', imgFrom: 'santorinidave.com', type: 'oldest winery on the island', group: 'Short drive — 15 min or less',
    ...
    priceSource: 'not published on their site — €3 a sample / €6 a glass comes from review guides, unverified',
  ...
  { name: 'Vassaltis Vineyards', cat: 'wine', img: 'img/vassaltis-vineyards.jpg', imgKind: 'venue', imgFrom: 'vassaltis.com', group: 'Short drive — 15 min or less', lat: 36.4344, lon: 25.4386, area: 'Vourvoulos', rank: 5,
    ...
    tastings: [
      { name: 'Vassaltis Tasting', price: '€40',
        includes: '4 wines with 4 bites — current vintages plus rare vinifications. Effectively a crash course in Assyrtiko, then the estate\'s lesser-known wines', note: 'no set length' },
      { name: 'Cellar Tour', dur: '1 h · daily 16:00–17:00', price: '€30',
        includes: 'Small-group cellar tour, 12 people maximum — how the wines are made and the facilities — then 4 wines in the tasting room' },
    ],
  ...
  { name: 'Domaine Sigalas', cat: 'wine', img: 'img/domaine-sigalas.jpg', imgKind: 'venue', imgFrom: 'sigalas-wine.com', group: 'The north end — 25–30 min each way', lat: 36.4713, lon: 25.3943, area: 'Baxedes, near Oia', rank: 4,
    ...
    tastings: [
      { name: 'Premium Wine & Food Experience', dur: '1 h 30',
        includes: 'Guided walk in one of the oldest vineyards in the world · flight of 5 high-end wines made in-house from indigenous Santorini grapes, each paired with a dish by their awarded chef · plus one bonus wine' },
      { name: 'Wine & Food Experience', dur: '1 h 30',
  ...
  { name: 'Hatzidakis Winery', cat: 'wine', img: 'img/hatzidakis-winery.jpg', imgKind: 'venue', imgFrom: 'hatzidakiswines.gr', group: 'Short drive — 15 min or less', lat: 36.3713, lon: 25.4394, area: 'Pyrgos Kallistis', rank: 7,
    ...
    tastings: [
      { name: 'Guided tour + 4 wines', dur: 'about 1 h', price: '€40',
        includes: 'Tour from the stainless-steel tanks to the barrel cave where the Vinsanto ages · 4 wines each presented in detail · Naxos goat cheese and bread rusks · tasting held in the barrel cave at monastery tables' },
      { name: 'Guided tour + 6 wines + vineyard', dur: 'about 1 h 30', price: '€80',
        includes: 'Vineyard visit with their agronomist or oenologist on organic growing · full winery tour to the barrel cave · 6 wines · Naxos goat cheese and bread rusks' },
      { name: 'Premium: 12 wines, older vintages', dur: 'about 2 h 30', price: '€160',
        includes: 'Private tour with an oenologist or sommelier · comparative tasting of 12 wines, old vintages against recent releases · vineyard and full winery tour · Aegean cheeses and rusks · served at their Wine Library for 1–8 people',
        note: 'book at least a day ahead' },
    ],
  ...
  { name: 'Venetsanos', cat: 'wine', img: 'img/venetsanos.jpg', imgKind: 'venue', imgFrom: 'venetsanoswinery.com', group: 'Short drive — 15 min or less', lat: 36.3825, lon: 25.4315, area: 'Megalochori, above Athinios', rank: 6,
    price: '€58–61', dur: '75–90 min',
    url: 'https://venetsanoswinery.com/',
    tastings: [
      { name: 'Museum Winery Tour & Wine Tasting', dur: '75 min', price: '€61',
        includes: 'Guided tour of the first industrial winery on the island, the Venetsanos family history and the terroir · 5 wines at 35 ml each, paired with Greek and local delicacies · caldera views throughout' },
      { name: 'Wine Tasting and Light Lunch', dur: '90 min', price: '€58',
        includes: '4 wines at 50 ml each with a food pairing of Greek and local delicacies, over the caldera' },
    ],
    priceSource: 'venetsanoswinery.com, checked with you Aug 2026 — the old €2 tour + €10 tasting figure is dead',
    note: 'The 1947 gravity-fed industrial winery built into the cliff above the ferry port.',
    verdict: 'The most dramatic building on the island, but no longer a cheap stop — €58–61 puts it above Gavalas Premium. Pay it for the cliff, not the pour.' },
  { name: 'Pelican Kipos', cat: 'wine', img: 'img/pelican-kipos.png', imgKind: 'venue', imgFrom: 'pelicankipos.com', group: 'Short drive — 15 min or less', lat: 36.4184, lon: 25.4328, area: 'Fira centre', rank: 9,
    ...
    priceSource: 'not published — €30 for 5 wines comes from a review guide, unverified',
  ...
  { name: 'Santo Wines', cat: 'wine', img: 'img/santo-wines.jpg', imgKind: 'venue', imgFrom: 'santowines.gr', group: 'Short drive — 15 min or less', lat: 36.3876, lon: 25.4365, area: 'Pyrgos', rank: 10,
    ...
    priceSource: 'not published on santowines.gr — flights €18–55 comes from review guides, unverified',
