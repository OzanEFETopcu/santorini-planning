...
const PLACES = [
  ...
  { name: 'Fratzeskos Fish Tavern', cat: 'dinner', img: 'img/fratzeskos-fish-tavern.jpg', imgKind: 'satellite', imgFrom: 'satellite view', type: 'fish taverna', group: 'Close to the base — 15 min or less', lat: 36.3530, lon: 25.4712, area: 'Perissa beachfront', rank: 6,
  ...
  { name: 'Lava Tavern', cat: 'dinner', img: 'img/lava-tavern.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · ArticCynda', type: 'beach taverna', group: 'Close to the base — 15 min or less', lat: 36.3400, lon: 25.4560, area: 'Perivolos, Agios Georgios end', rank: 7,
  ...
  { name: 'Forty One', cat: 'beach', img: 'img/forty-one.jpg', imgKind: 'venue', imgFrom: 'forty-one.site', type: 'beach club & sushi bar', group: 'Beach clubs',
    lat: 36.3399, lon: 25.4539, area: 'Perivolos beach', rank: 8,
  ...
  { name: 'Seaside Santorini', cat: 'beach', img: 'img/seaside-santorini.jpg', imgKind: 'satellite', imgFrom: 'satellite view', type: 'beach club', group: 'Beach clubs',
    lat: 36.3396, lon: 25.4522, area: 'Perivolos beach', rank: 9,
  ...
  { name: 'Theros Wave Bar', cat: 'beach', img: 'img/theros-wave-bar.jpg', imgKind: 'satellite', imgFrom: 'satellite view', type: 'beach club', group: 'Beach clubs',
    lat: 36.3455, lon: 25.4230, area: 'Eros beach, Vlychada', rank: 6,
  ...
  { name: 'Wet Stories', cat: 'beach', img: 'img/wet-stories.jpg', imgKind: 'venue', imgFrom: 'wetstoriessantorini.gr', type: 'beach club', group: 'Beach clubs',
    lat: 36.3420, lon: 25.4590, area: 'Perivolos beach', rank: 7,
