...
const PLACES = [
  ...
  { name: 'Fratzeskos Fish Tavern', cat: 'dinner', img: 'img/fratzeskos-fish-tavern.jpg', imgKind: 'satellite', imgFrom: 'satellite view', type: 'fish taverna', group: 'Close to the base — 15 min or less', lat: 36.3568, lon: 25.4694, area: 'Perissa beachfront', rank: 6,
  ...
  { name: 'Lava Tavern', cat: 'dinner', img: 'img/lava-tavern.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · ArticCynda', type: 'beach taverna', group: 'Close to the base — 15 min or less', lat: 36.3452, lon: 25.4530, area: 'Perivolos, Agios Georgios end', rank: 7,
  ...
  { name: 'Ouzeri', cat: 'dinner', img: 'img/ouzeri.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · Norbert Nagel', type: 'ouzeri', group: 'Close to the base — 15 min or less', lat: 36.4158, lon: 25.4315, area: 'Fira, Fabrika centre', rank: 8,
  ...
  { name: 'I Spilia tou Nikola', cat: 'dinner', img: 'img/i-spilia-tou-nikola.webp', imgKind: 'venue', imgFrom: 'nikolascave.gr', type: 'cave fish taverna', group: 'Close to the base — 15 min or less',
    lat: 36.3486, lon: 25.3936, area: 'Akrotiri', rank: 3,
  ...
  { name: 'Fino', cat: 'dinner', img: 'img/fino.jpg', imgKind: 'venue', imgFrom: 'finosantorini.gr', type: 'creative Greek', group: 'The north end — 25–30 min each way',
    lat: 36.4605, lon: 25.3752, area: 'Oia', rank: 11,
  ...
  { name: 'Anogi', cat: 'dinner', img: 'img/anogi.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · Κλέαρχος Π. Καπούτσης', type: 'taverna', group: 'The north end — 25–30 min each way',
    lat: 36.4322, lon: 25.4234, area: 'Imerovigli', rank: 13,
  ...
  { name: 'Dimitris Ammoudi Taverna', cat: 'dinner', img: 'img/dimitris-ammoudi-taverna.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · Anthony Baratier', type: 'fish taverna', group: 'The north end — 25–30 min each way', lat: 36.4650, lon: 25.3733, area: 'Ammoudi Bay, below Oia', rank: 12,
  ...
  { name: 'Tholoto Brunch & Restaurant', cat: 'brekky', img: 'img/tholoto-brunch-restaurant.jpg', imgKind: 'area', imgFrom: 'area photo · Wikimedia · Norbert Nagel', also: ['dinner'], type: 'brunch & restaurant', group: 'Close to the base — 15 min or less',
    lat: 36.4197, lon: 25.4356, area: 'Kontochori, Fira', rank: 9,
